...
export const STORIES: Story[] = [
  {
    ...
    body: [
      ...
      {
        type: "p",
        text: "Kwati (say it kwah-tee) is a thick soup of nine different beans, sprouted for a few days until they just start to tail, then simmered with ginger, garlic, timmur and jimbu until everything goes soft and the broth turns nutty and dark. The name comes from the Newari words for nine and hot, a hot dish of nine beans. It is hearty in a way most soups are not. You can almost stand a spoon in a good pot of it.",
      },
      {
        type: "p",
        text: "It tastes of the beans themselves, roasty and grounding, lifted by the woodsy hit of jimbu and a slow warmth from the timmur. Some homes keep it vegetarian, some drop in a little smoked pork or dried fish. Either way it eats like a meal, ladled over rice, not a starter.",
      },
      ...
      },
      {
        ...
        items: [
          ...
          "1/2 tsp timmur, lightly crushed",
      ...
      },
      {
        ...
        items: [
          ...
          "Crush in the timmur near the end, season with salt, and finish with coriander. Serve hot over rice.",
        ],
      },
      {
        type: "p",
        text: "If you want it the way many Newar homes do, drop in a little smoked pork or dried fish with the onions. And do not skip the timmur at the end. It is the difference between a bean soup and kwati.",
      },
      ...
      },
      {
        ...
        items: [
          {
            q: "What is kwati?",
            a: "Kwati is a Nepali soup of nine sprouted beans, simmered with ginger, garlic, timmur and jimbu. It is thick, earthy and eaten over rice, traditionally at the Janai Purnima festival.",
          },
          {
