...
export default async function AdminEdit({
	...
	return (
		<div className="max-w-[820px] mx-auto px-4 sm:px-6 py-8">
			...
			<h1 className="font-display font-extrabold text-2xl text-ink-900 mt-2 mb-1">
				{r.name}
			</h1>
			...
			<RestaurantEditor
				...
				initialMenuFiles={menuFiles}
			/>

			<div className="mt-10 pt-6 border-t border-ink-100">
				<h2 className="font-display font-extrabold text-lg text-ink-900 mb-1">
					Danger zone
				</h2>
				<p className="text-ink-500 text-sm mb-3">
					Permanently removes this restaurant and all its photos and
					menu files.
				</p>
				<DeleteSpotButton
					slug={r.slug}
