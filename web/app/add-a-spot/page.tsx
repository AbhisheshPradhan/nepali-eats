	...
	return (
		<div className="max-w-[680px] mx-auto px-4 sm:px-6 py-16 text-center">
			...
			<p className="text-ink-700 text-[1.2rem] leading-relaxed mb-8">
				We are building a simple way for you to add your favourite
				Nepali kitchen, cafe, food truck or weekend stall to the map.
				For now, keep exploring the hundreds of spots already here.
			</p>
			<Button
				href="/explore"
				iconLeft={
