...
export default function StoriesPage() {
	...
	return (
		<div className="max-w-[1180px] mx-auto px-4 sm:px-6 pt-10">
			...
			<p className="text-ink-500 mb-8 text-[1.15rem] max-w-[620px]">
				City guides, dish explainers and the people behind the kitchens
				we love.
			</p>
					...
					{featured.tags.length > 0 && (
						<div className="flex flex-wrap gap-2 mb-4.5">
							{featured.tags.map((t) => (
								<Tag
									key={t}
									className="text-[0.8rem] px-3 py-1"
								>
									{t}
								</Tag>
							))}
				...
				{rest.map((p) => (
					...
					>
						...
						<div className="p-5 flex flex-col gap-2.5 flex-1">
							...
							<p className="text-ink-700 leading-snug flex-1">
								{p.dek}
							</p>
