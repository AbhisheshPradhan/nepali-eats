# NepaliEats — Voice & Tone Guide

The single reference for how every word on NepaliEats sounds. Copy, microcopy,
buttons, empty states, meta descriptions, and blog posts all follow this. When in
doubt, read it aloud and ask: would a Nepali food lover say this to a friend?

**Owner:** copy lead. **Applies to:** all user-facing text and content.
...
We write for all three at once: clear enough for a newcomer, warm enough that a
...
2. **Food-obsessed and specific.** We name the dish. Momo, Thakali dal bhat, sel
   roti, choila, jhol. Specifics build trust and appetite. Generic "cuisine" and
   "dishes" are weak.
3. **Confident, not salesy.** We make plain claims ("every Nepali restaurant in
   Australia") and let the food do the talking. No hype, no exclamation marks.
4. **Proudly Nepali.** Respectful of the culture and the regional traditions
...
- **Microcopy / empty states:** light, helpful, a touch of charm.
- **Meta titles / descriptions:** clear and keyworded. This is sales copy in the
  search result, not an afterthought.
...
- **No em dashes (—) or en dashes (–) anywhere, including titles.** Use commas,
  colons, parentheses, or a new sentence. Hyphens in compound words
  (hole-in-the-wall) are fine. For page/meta `<title>` separators use a normal
  hyphen "-", for example "Best momo in Australia - NepaliEats".
- **No AI-tell words:** delve, leverage, seamless, robust, comprehensive, pivotal,
  innovative, intricate, nuanced, holistic, streamline, foster, elevate, curate.
- **No AI-tell phrases:** "In today's...", "It's worth noting", "At its core",
  "Whether you're X, Y, or Z", "It's not just X, it's Y", "In conclusion".
- **No empty intensifiers:** very, really, simply, truly, ultimately, actually,
  basically, clearly, obviously.
- **No twee filler:** "happy place", "culinary journey".
- **Do not call spots "hidden gems" in general copy.** "Hidden gems" is reserved
  as a future tag/category, so it has to mean something specific. We cannot say
  every restaurant is a hidden gem. Keep the phrase out of headings, intros, and
  the blurb generator until the tag exists.
...
"Find your momo people" is the recurring signature. Use it in the footer, the OG
image, social bios, and as the emotional close on key pages. It is the tagline,
not the headline.
...
- **Before:** "Every hidden gem serving real Nepali food, gathered in one happy
  place." **After:** "Every Nepali kitchen, cafe and food truck in Australia, on
  one map."
- **Before (empty state):** "No spots in view. Pan the map or zoom out."
...
- [ ] CTA says what happens.
- [ ] Reads naturally aloud.
- [ ] AU spelling (flavour, neighbourhood, centre).
